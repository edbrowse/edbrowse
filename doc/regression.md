...
It consists of 100 tests, but I only run the first 64.
...
So 56 tests in practice.
I'd like to go back to these some day, the 8 that were skipped and the latter 36.
...
If, after a few seconds, line 3 says 64/64, you're good.
If the first number, the number of tests passed, is less than 64,
