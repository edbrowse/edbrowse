...
// htmlTag.action, these are in no particular order
enum {
    TAGACT_UNKNOWN, TAGACT_DOCTYPE, TAGACT_HTML,
    TAGACT_HE, // generic html element
    TAGACT_BODY, TAGACT_HEAD, TAGACT_DOC, TAGACT_FRAG, TAGACT_COMMENT,
    TAGACT_A, TAGACT_INPUT, TAGACT_TITLE, TAGACT_TIME,
    ...
    TAGACT_IMAGE, TAGACT_BR, TAGACT_IBR, TAGACT_P, TAGACT_SHADOW,
    TAGACT_BASE, TAGACT_META, TAGACT_LINK, TAGACT_PRE, TAGACT_LABEL,
    TAGACT_TBODY, TAGACT_THEAD, TAGACT_TFOOT, TAGACT_CAPTION,
    ...
    TAGACT_FORM, TAGACT_FIELDSET, TAGACT_LEGEND,
    TAGACT_FRAME, TAGACT_STYLE, TAGACT_CANVAS,
    // this range has to start with SVG and end with POLYGON
    TAGACT_SVG, TAGACT_DEFS, TAGACT_USE, TAGACT_PATH, TAGACT_G,
    TAGACT_STOP, TAGACT_ELLIPSE, TAGACT_MASK, TAGACT_RECT,
    TAGACT_GRADIENT, TAGACT_LINEARGRADIENT,     TAGACT_POLYGON,
    TAGACT_MAP, TAGACT_AREA, TAGACT_SCRIPT, TAGACT_NOSCRIPT, TAGACT_EMBED,
    TAGACT_OBJ, TAGACT_DATAL,
    TAGACT_DET, TAGACT_SUMMARY,
    // tags that change font but also have a semantic meaning
    // the order is important here
    TAGACT_EM, TAGACT_STRONG, TAGACT_B, TAGACT_I,
    TAGACT_U, TAGACT_INS, TAGACT_S, TAGACT_DEL, TAGACT_CODE,
};
