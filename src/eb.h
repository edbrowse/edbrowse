...
TAGACT_A, TAGACT_INPUT, TAGACT_TITLE, TAGACT_TIME,
	...
	TAGACT_OBJ, TAGACT_DATAL, TAGACT_B, TAGACT_CODE, TAGACT_DEL, TAGACT_EM,
	TAGACT_I, TAGACT_INS, TAGACT_S, TAGACT_STRONG, TAGACT_U,
	TAGACT_DET, TAGACT_SUMMARY, TAGACT_UNKNOWN,
};
